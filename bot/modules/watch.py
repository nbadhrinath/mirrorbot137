...
def _watch(bot: Bot, update, isTar=False, isZip=False, isLeech=False):
    ...
    try:
        ...
        msg += "<b>✴️Note: Quality and custom name are optional</b>\n\nExample of quality: audio, 144, 240, 360, 480, 720, 1080, 2160."
        msg += "\n\n✴️If you want to use custom filename, enter it after |"
        msg += f"\n\n💠Example:\n<code>/{BotCommands.WatchCommand} https://youtu.be/Pk_TthHfLeE 720 |Name</code>\n\n"
        msg += "✴️This file will be downloaded in 720p quality and it's name will be <b>Name</b>"
